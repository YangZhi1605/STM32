...
static void ADCx_Mode_Config(void)
{
	...
	DMA_InitStructure.DMA_BufferSize = NOFCHANEL; //已修改
	
	// 外设寄存器只有一个，地址不用递增
	DMA_InitStructure.DMA_PeripheralInc = DMA_PeripheralInc_Disable;

	// 存储器地址固定
	DMA_InitStructure.DMA_MemoryInc = DMA_MemoryInc_Enable; //已修改
	...
	ADC_InitStruct.ADC_ScanConvMode = ENABLE; //因为是多通道了，扫描这块需要改
